...
const ShowInvite = ({
  ...
  const scriptUrl = 'https://script.google.com/macros/s/AKfycbxT2ULa9alnZIvTQifLty40uuOnafTTCm2rXQFeiDOb7ERi716dteMZCH5mqU_pxRDtfA/exec';
  const handleSubmit = async e => {
    ...
    try {
      ...
      /* eslint-disable */
      console.log(...oo_oo(`783393367_0`, data));
